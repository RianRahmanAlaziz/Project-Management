...
export default function WorkspaceCard({
    ...
    return (
        <article
            ...
            <div className="mb-5 flex min-h-18 items-start justify-between gap-3">
                <div className="flex min-w-0 items-start gap-3">
                    ...
                    <div className="flex min-h-18 flex-1 flex-col">
            ...
            <div className="mt-auto flex flex-wrap items-center gap-x-5 gap-y-2 border-t border-border pt-4 text-sm text-muted-foreground">
