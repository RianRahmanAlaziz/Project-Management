...
export const WORKSPACES = [
    { id: "ws1", name: "Acme Corp", description: "Main product workspace", members: 12, projects: 8, color: "bg-indigo-500", initials: "AC" },
    { id: "ws2", name: "Design Hub", description: "UI/UX and brand projects", members: 5, projects: 4, color: "bg-violet-500", initials: "DH" },
    { id: "ws3", name: "Growth Team", description: "Marketing and analytics", members: 7, projects: 6, color: "bg-emerald-500", initials: "GT" },
];

export const PROJECTS = [
    { id: "p1", name: "ProjectFlow v2.0", workspace: "ws1", status: "In Progress", progress: 68, color: "bg-indigo-500", members: ["u1", "u2", "u3"], dueDate: "2026-07-15", priority: "High", tasks: 42 },
    { id: "p2", name: "Mobile App Redesign", workspace: "ws1", status: "In Progress", progress: 34, color: "bg-violet-500", members: ["u2", "u4"], dueDate: "2026-08-01", priority: "Medium", tasks: 28 },
    { id: "p3", name: "API Gateway Migration", workspace: "ws1", status: "Review", progress: 85, color: "bg-blue-500", members: ["u1", "u3", "u5"], dueDate: "2026-06-30", priority: "High", tasks: 19 },
    { id: "p4", name: "Brand Refresh 2026", workspace: "ws2", status: "Todo", progress: 10, color: "bg-pink-500", members: ["u2"], dueDate: "2026-09-01", priority: "Low", tasks: 15 },
    { id: "p5", name: "Q3 Marketing Campaign", workspace: "ws3", status: "In Progress", progress: 55, color: "bg-emerald-500", members: ["u1", "u4", "u5"], dueDate: "2026-07-30", priority: "Medium", tasks: 33 },
];
