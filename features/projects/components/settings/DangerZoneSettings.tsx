...
export default function DangerZoneSettings(
    ...
    const canDelete = confirmDelete === projectSlug;
    return (
        <div className="space-y-4">
            ...
            <DangerCard
                ...
                desc="Download all tasks, comments, and activity as JSON or CSV."
                action={
                    <Button
                        size="lg"
                        variant="outline">
            ...
            <DangerCard
                ...
                desc="Mark this project as archived. Tasks become read-only but are preserved."
                action={
                    <Button
                        size="lg"
                        variant="outline">Archive
                    </Button>
                } />
            <DangerCard
                ...
                action={
                    <div className="space-y-2">
                        <p className="text-xs text-muted-foreground">
                            Type <span className="font-mono font-bold text-foreground">{projectSlug}</span> to confirm:
                        </p>
